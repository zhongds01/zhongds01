...
public class ISARadiusHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -5815728491166007269L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISARadiusHis";
  ...
  public ISARadiusHis() throws AIException{
      super(S_TYPE);
  }
