...
public class ISAMcasHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -956914854092647444L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISAMcasHis";
  ...
  public ISAMcasHis() throws AIException{
      super(S_TYPE);
  }
