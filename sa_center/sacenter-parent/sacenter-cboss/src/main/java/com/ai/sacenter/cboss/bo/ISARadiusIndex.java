...
public class ISARadiusIndex extends DataContainer implements DataContainerInterface,IISARadiusIndex{
  private static final long serialVersionUID = 7776276693975375745L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISARadiusIndex";
  ...
  public ISARadiusIndex() throws AIException{
      super(S_TYPE);
  }
