...
public class ISABrandChgHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -5639115897334438509L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISABrandChgHis";
  ...
  public ISABrandChgHis() throws AIException{
      super(S_TYPE);
  }
