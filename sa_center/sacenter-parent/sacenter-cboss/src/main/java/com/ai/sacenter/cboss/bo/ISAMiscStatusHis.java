...
public class ISAMiscStatusHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = 2355209110394756347L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISAMiscStatusHis";
  ...
  public ISAMiscStatusHis() throws AIException{
      super(S_TYPE);
  }
