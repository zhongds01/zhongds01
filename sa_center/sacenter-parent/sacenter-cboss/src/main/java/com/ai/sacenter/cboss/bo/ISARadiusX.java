...
public class ISARadiusX extends DataContainer implements DataContainerInterface,IISARadiusX{
  private static final long serialVersionUID = 8377465180393447252L;
  private static String  m_boName = "com.ai.sacenter.cboss.bo.ISARadiusX";
  ...
  public ISARadiusX() throws AIException{
      super(S_TYPE);
  }
