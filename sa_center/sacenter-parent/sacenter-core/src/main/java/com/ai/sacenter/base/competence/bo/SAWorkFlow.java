...
public class SAWorkFlow extends DataContainer implements DataContainerInterface,ISAWorkFlow{
  private static final long serialVersionUID = 4239755914615831742L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SAWorkFlow";
  ...
  public SAWorkFlow() throws AIException{
      super(S_TYPE);
  }
