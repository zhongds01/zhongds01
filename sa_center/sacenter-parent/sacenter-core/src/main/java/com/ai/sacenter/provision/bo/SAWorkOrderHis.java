...
public class SAWorkOrderHis extends DataContainer implements DataContainerInterface,ISAWorkOrder{
  private static final long serialVersionUID = -4498163644723139020L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.SAWorkOrderHis";
  ...
  public SAWorkOrderHis() throws AIException{
      super(S_TYPE);
  }
