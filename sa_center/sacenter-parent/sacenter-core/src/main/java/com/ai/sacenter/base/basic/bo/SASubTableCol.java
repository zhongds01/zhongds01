...
public class SASubTableCol extends DataContainer implements DataContainerInterface,ISASubTableCol{
  private static final long serialVersionUID = 5977611284761100759L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SASubTableCol";
  ...
  public SASubTableCol() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initDestColumn(String value){
     this.initProperty(S_DestColumn,value);
  }
  public  void setDestColumn(String value){
     this.set(S_DestColumn,value);
  }
  public  void setDestColumnNull(){
     this.set(S_DestColumn,null);
  }

  public String getDestColumn(){
       return DataType.getAsString(this.get(S_DestColumn));
  
  }
  public String getDestColumnInitialValue(){
        return DataType.getAsString(this.getOldObj(S_DestColumn));
      }
  ...
  public void initSrcColumn(String value){
     this.initProperty(S_SrcColumn,value);
  }
  public  void setSrcColumn(String value){
     this.set(S_SrcColumn,value);
  }
  public  void setSrcColumnNull(){
     this.set(S_SrcColumn,null);
  }

  public String getSrcColumn(){
       return DataType.getAsString(this.get(S_SrcColumn));
  
  }
  public String getSrcColumnInitialValue(){
        return DataType.getAsString(this.getOldObj(S_SrcColumn));
      }
