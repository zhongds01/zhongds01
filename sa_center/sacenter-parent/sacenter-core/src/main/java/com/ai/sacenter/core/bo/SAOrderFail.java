...
public class SAOrderFail extends DataContainer implements DataContainerInterface,ISAOrder{
  private static final long serialVersionUID = 6791562267274501776L;
  private static String  m_boName = "com.ai.sacenter.core.bo.SAOrderFail";
  ...
  public SAOrderFail() throws AIException{
      super(S_TYPE);
  }
