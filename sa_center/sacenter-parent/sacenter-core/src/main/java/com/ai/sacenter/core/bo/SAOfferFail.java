...
public class SAOfferFail extends DataContainer implements
		DataContainerInterface, ISAOffer {

	private static final long serialVersionUID = 4664586304998483773L;

	private static String m_boName = "com.ai.sacenter.core.bo.SAOfferFail";
	...
	public SAOfferFail() throws AIException {
		super(S_TYPE);
	}
