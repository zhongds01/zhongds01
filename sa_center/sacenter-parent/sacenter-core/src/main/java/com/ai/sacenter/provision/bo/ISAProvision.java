...
public class ISAProvision extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -8759249824695649541L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISAProvision";
  ...
  public ISAProvision() throws AIException{
      super(S_TYPE);
  }
