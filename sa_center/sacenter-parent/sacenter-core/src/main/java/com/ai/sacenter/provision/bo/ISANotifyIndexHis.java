...
public class ISANotifyIndexHis extends DataContainer implements DataContainerInterface,IISANotifyIndex{
  private static final long serialVersionUID = -3993823227155727137L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISANotifyIndexHis";
  ...
  public ISANotifyIndexHis() throws AIException{
      super(S_TYPE);
  }
