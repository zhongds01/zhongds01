...
public class SAComptelRel extends DataContainer implements DataContainerInterface,ISAComptelRel{
  private static final long serialVersionUID = -6925863464925961436L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SAComptelRel";
  ...
  public SAComptelRel() throws AIException{
      super(S_TYPE);
  }
