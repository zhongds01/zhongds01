...
public class ISAProvisionReset extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -2032915295306157266L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISAProvisionReset";
  ...
  public ISAProvisionReset() throws AIException{
      super(S_TYPE);
  }
