...
public class SASuggestFail extends DataContainer implements DataContainerInterface,ISASuggest{
  private static final long serialVersionUID = 6449112109455253922L;
  private static String  m_boName = "com.ai.sacenter.suggest.bo.SASuggestFail";
  ...
  public SASuggestFail() throws AIException{
      super(S_TYPE);
  }
