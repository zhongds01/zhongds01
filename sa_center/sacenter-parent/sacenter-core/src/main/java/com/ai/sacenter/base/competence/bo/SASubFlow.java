...
public class SASubFlow extends DataContainer implements DataContainerInterface,ISASubFlow{
  private static final long serialVersionUID = 3998808444096078880L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SASubFlow";
  ...
  public SASubFlow() throws AIException{
      super(S_TYPE);
  }
