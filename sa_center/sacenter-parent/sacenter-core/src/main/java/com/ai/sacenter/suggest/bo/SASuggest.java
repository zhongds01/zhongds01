...
public class SASuggest extends DataContainer implements DataContainerInterface,ISASuggest{
  private static final long serialVersionUID = 7874894563080392582L;
  private static String  m_boName = "com.ai.sacenter.suggest.bo.SASuggest";
  ...
  public SASuggest() throws AIException{
      super(S_TYPE);
  }
