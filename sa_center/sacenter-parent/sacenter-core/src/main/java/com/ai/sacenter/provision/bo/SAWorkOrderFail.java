...
public class SAWorkOrderFail extends DataContainer implements DataContainerInterface,ISAWorkOrder{
  private static final long serialVersionUID = -5849935039131284012L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.SAWorkOrderFail";
  ...
  public SAWorkOrderFail() throws AIException{
      super(S_TYPE);
  }
