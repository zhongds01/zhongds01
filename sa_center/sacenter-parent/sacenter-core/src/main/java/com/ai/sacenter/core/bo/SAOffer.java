...
public class SAOffer extends DataContainer implements DataContainerInterface,
		ISAOffer {
	private static final long serialVersionUID = 7381306023956368512L;
	private static String m_boName = "com.ai.sacenter.core.bo.SAOffer";
	...
	public SAOffer() throws AIException {
		super(S_TYPE);
	}
