...
public class SATaskHis extends DataContainer implements DataContainerInterface,ISATask{
  private static final long serialVersionUID = 4944326169125145594L;
  private static String  m_boName = "com.ai.sacenter.core.bo.SATaskHis";
  ...
  public SATaskHis() throws AIException{
      super(S_TYPE);
  }
