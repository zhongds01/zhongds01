...
public class SATaskFail extends DataContainer implements DataContainerInterface,ISATask{
  private static final long serialVersionUID = -3237080643531108171L;
  private static String  m_boName = "com.ai.sacenter.core.bo.SATaskFail";
  ...
  public SATaskFail() throws AIException{
      super(S_TYPE);
  }
