...
public class SACompetence extends DataContainer implements DataContainerInterface,ISACompetence{
  private static final long serialVersionUID = -1023078878785388378L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SACompetence";
  ...
  public SACompetence() throws AIException{
      super(S_TYPE);
  }
