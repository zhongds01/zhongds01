...
public class SAQueueHis extends DataContainer implements
		DataContainerInterface, ISAQueue {
	private static final long serialVersionUID = -5104966262289150833L;

	private static String m_boName = "com.ai.sacenter.core.bo.SAQueueHis";
	...
	public SAQueueHis() throws AIException {
		super(S_TYPE);
	}
