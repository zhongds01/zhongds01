...
public class SAProgram extends DataContainer implements DataContainerInterface,ISAProgram{
  private static final long serialVersionUID = 658629619181392988L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SAProgram";
  ...
  public SAProgram() throws AIException{
      super(S_TYPE);
  }
