...
public class ISANotifyIndex extends DataContainer implements DataContainerInterface,IISANotifyIndex{
  private static final long serialVersionUID = -2504839382882773026L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISANotifyIndex";
  ...
  public ISANotifyIndex() throws AIException{
      super(S_TYPE);
  }
