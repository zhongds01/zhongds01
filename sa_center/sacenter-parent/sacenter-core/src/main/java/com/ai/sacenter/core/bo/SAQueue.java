...
public class SAQueue extends DataContainer implements DataContainerInterface, ISAQueue {
	private static final long serialVersionUID = -8962390892343654884L;
	private static String m_boName = "com.ai.sacenter.core.bo.SAQueue";
	...
	public SAQueue() throws AIException {
		super(S_TYPE);
	}
