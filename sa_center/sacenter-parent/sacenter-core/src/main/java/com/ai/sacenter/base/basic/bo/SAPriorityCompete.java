...
public class SAPriorityCompete extends DataContainer implements DataContainerInterface,ISAPriorityCompete{
  private static final long serialVersionUID = -7128113737489886822L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SAPriorityCompete";
  ...
  public SAPriorityCompete() throws AIException{
      super(S_TYPE);
  }
