...
public class SAClient extends DataContainer implements DataContainerInterface,ISAClient{
  private static final long serialVersionUID = 1758398738856642266L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SAClient";
  ...
  public SAClient() throws AIException{
      super(S_TYPE);
  }
