...
public class SALibrary extends DataContainer implements DataContainerInterface,ISALibrary{
  private static final long serialVersionUID = 4763100916772714539L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SALibrary";
  ...
  public SALibrary() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initMethod(String value){
     this.initProperty(S_Method,value);
  }
  public  void setMethod(String value){
     this.set(S_Method,value);
  }
  public  void setMethodNull(){
     this.set(S_Method,null);
  }

  public String getMethod(){
       return DataType.getAsString(this.get(S_Method));
  
  }
  public String getMethodInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Method));
      }
