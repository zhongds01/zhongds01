...
public class SAFeature extends DataContainer implements DataContainerInterface,ISAFeature{
  private static final long serialVersionUID = -7909960173421142429L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SAFeature";
  ...
  public SAFeature() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initCategory(int value){
     this.initProperty(S_Category,new Integer(value));
  }
  public  void setCategory(int value){
     this.set(S_Category,new Integer(value));
  }
  ...
  public int getCategory(){
        return DataType.getAsInt(this.get(S_Category));
  
  }
  public int getCategoryInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_Category));
      }
