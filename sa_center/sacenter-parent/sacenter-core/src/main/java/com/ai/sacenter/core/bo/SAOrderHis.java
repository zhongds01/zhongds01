...
public class SAOrderHis extends DataContainer implements DataContainerInterface,ISAOrder{
  private static final long serialVersionUID = 1227960231523449042L;
  private static String  m_boName = "com.ai.sacenter.core.bo.SAOrderHis";
  ...
  public SAOrderHis() throws AIException{
      super(S_TYPE);
  }
