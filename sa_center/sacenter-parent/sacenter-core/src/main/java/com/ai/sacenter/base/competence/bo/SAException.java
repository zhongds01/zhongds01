...
public class SAException extends DataContainer implements DataContainerInterface,ISAException{
  private static final long serialVersionUID = -3700183057598949155L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SAException";
  ...
  public final static  String S_Respond = "RESPOND";
  ...
  public SAException() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRespond(String value){
     this.initProperty(S_Respond,value);
  }
  public  void setRespond(String value){
     this.set(S_Respond,value);
  }
  public  void setRespondNull(){
     this.set(S_Respond,null);
  }

  public String getRespond(){
       return DataType.getAsString(this.get(S_Respond));
  
  }
  public String getRespondInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Respond));
      }
