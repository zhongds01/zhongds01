...
public class SAPriorityLimite extends DataContainer implements DataContainerInterface,ISAPriorityLimite{
  private static final long serialVersionUID = 2217459510874900507L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SAPriorityLimite";
  ...
  public SAPriorityLimite() throws AIException{
      super(S_TYPE);
  }
