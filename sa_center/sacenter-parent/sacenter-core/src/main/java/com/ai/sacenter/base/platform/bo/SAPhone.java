...
public class SAPhone extends DataContainer implements DataContainerInterface,ISAPhone{
  private static final long serialVersionUID = 4774185772323847562L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SAPhone";
  ...
  public SAPhone() throws AIException{
      super(S_TYPE);
  }
