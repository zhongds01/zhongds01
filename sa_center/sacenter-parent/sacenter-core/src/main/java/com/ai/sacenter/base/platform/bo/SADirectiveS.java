...
public class SADirectiveS extends DataContainer implements DataContainerInterface,ISADirectiveS{
  private static final long serialVersionUID = -7039381988047455529L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SADirectiveS";
  ...
  public SADirectiveS() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initJeval(String value){
     this.initProperty(S_Jeval,value);
  }
  public  void setJeval(String value){
     this.set(S_Jeval,value);
  }
  public  void setJevalNull(){
     this.set(S_Jeval,null);
  }

  public String getJeval(){
       return DataType.getAsString(this.get(S_Jeval));
  
  }
  public String getJevalInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Jeval));
      }
