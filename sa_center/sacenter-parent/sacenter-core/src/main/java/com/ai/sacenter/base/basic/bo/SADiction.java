...
public class SADiction extends DataContainer implements DataContainerInterface,ISADiction{
  private static final long serialVersionUID = -6317162317133100733L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SADiction";
  ...
  public SADiction() throws AIException{
      super(S_TYPE);
  }
