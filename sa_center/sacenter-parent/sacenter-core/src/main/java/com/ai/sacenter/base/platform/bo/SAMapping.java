...
public class SAMapping extends DataContainer implements DataContainerInterface,ISAMapping{
  private static final long serialVersionUID = 206774262277209011L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SAMapping";
  ...
  public SAMapping() throws AIException{
      super(S_TYPE);
  }
