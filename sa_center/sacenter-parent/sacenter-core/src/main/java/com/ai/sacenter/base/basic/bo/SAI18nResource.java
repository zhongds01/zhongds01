...
public class SAI18nResource extends DataContainer implements DataContainerInterface,ISAI18nResource{
  private static final long serialVersionUID = -2376471692696878546L;
  private static String  m_boName = "com.ai.sacenter.base.basic.bo.SAI18nResource";
  ...
  public SAI18nResource() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initExtend(String value){
     this.initProperty(S_Extend,value);
  }
  public  void setExtend(String value){
     this.set(S_Extend,value);
  }
  public  void setExtendNull(){
     this.set(S_Extend,null);
  }

  public String getExtend(){
       return DataType.getAsString(this.get(S_Extend));
  
  }
  public String getExtendInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Extend));
      }
  ...
  public void initDomain(String value){
	  this.initProperty(S_Domain,value);
  }

  public  void setDomain(String value){
	  this.set(S_Domain,value);
  }
  
  public  void setDomainNull(){
	  this.set(S_Domain,null);
  }
  
  public String getDomain(){
	  return DataType.getAsString(this.get(S_Domain));
  }
  
  public String getDomainInitialValue(){
	  return DataType.getAsString(this.getOldObj(S_Domain));
  }
