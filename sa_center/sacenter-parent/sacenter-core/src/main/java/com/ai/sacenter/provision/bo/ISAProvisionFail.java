...
public class ISAProvisionFail extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -5854932566969453666L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISAProvisionFail";
  ...
  public ISAProvisionFail() throws AIException{
      super(S_TYPE);
  }
