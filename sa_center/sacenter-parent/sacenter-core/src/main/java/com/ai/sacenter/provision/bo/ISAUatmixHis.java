...
public class ISAUatmixHis extends DataContainer implements
		DataContainerInterface, IISAUatmix {

	private static final long serialVersionUID = 6797902277210498102L;

	private static String m_boName = "com.ai.sacenter.provision.bo.ISAUatmixHis";
	...
	public ISAUatmixHis() throws AIException {
		super(S_TYPE);
	}
