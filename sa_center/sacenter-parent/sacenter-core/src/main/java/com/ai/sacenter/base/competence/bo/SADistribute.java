...
public class SADistribute extends DataContainer implements DataContainerInterface,ISADistribute{
  private static final long serialVersionUID = 4038000377342065927L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SADistribute";
  ...
  public SADistribute() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initDistribute(String value){
     this.initProperty(S_Distribute,value);
  }
  public  void setDistribute(String value){
     this.set(S_Distribute,value);
  }
  public  void setDistributeNull(){
     this.set(S_Distribute,null);
  }

  public String getDistribute(){
       return DataType.getAsString(this.get(S_Distribute));
  
  }
  public String getDistributeInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Distribute));
      }
