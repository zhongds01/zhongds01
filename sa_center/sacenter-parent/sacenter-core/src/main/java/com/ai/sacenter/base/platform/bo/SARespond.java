...
public class SARespond extends DataContainer implements DataContainerInterface,ISARespond{
  private static final long serialVersionUID = 6377779368023065175L;
  private static String  m_boName = "com.ai.sacenter.base.platform.bo.SARespond";
  public final static  String S_Complex = "COMPLEX";
  public final static  String S_Modifier = "MODIFIER";
  public final static  String S_Network = "NETWORK";
  public final static  String S_Succeed = "SUCCEED";
  ...
  public SARespond() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initSucceed(int value){
     this.initProperty(S_Succeed,new Integer(value));
  }
  public  void setSucceed(int value){
     this.set(S_Succeed,new Integer(value));
  }
  public  void setSucceedNull(){
     this.set(S_Succeed,null);
  }

  public int getSucceed(){
        return DataType.getAsInt(this.get(S_Succeed));
  
  }
  public int getSucceedInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_Succeed));
      }
