...
public class SAWorkOrder extends DataContainer implements DataContainerInterface,ISAWorkOrder{
  private static final long serialVersionUID = 7576380771544803288L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.SAWorkOrder";
  ...
  public SAWorkOrder() throws AIException{
      super(S_TYPE);
  }
