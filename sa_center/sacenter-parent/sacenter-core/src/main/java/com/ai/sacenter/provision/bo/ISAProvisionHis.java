...
public class ISAProvisionHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -5328375328257440752L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISAProvisionHis";
  ...
  public ISAProvisionHis() throws AIException{
      super(S_TYPE);
  }
