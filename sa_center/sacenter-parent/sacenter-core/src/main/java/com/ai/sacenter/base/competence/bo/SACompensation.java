...
public class SACompensation extends DataContainer implements DataContainerInterface,ISACompensation{
  private static final long serialVersionUID = -8536011326636614444L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SACompensation";
  ...
  public SACompensation() throws AIException{
      super(S_TYPE);
  }
