...
public class ISAProvisionBuff extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -1859056537776032899L;
  private static String  m_boName = "com.ai.sacenter.provision.bo.ISAProvisionBuff";
  ...
  public ISAProvisionBuff() throws AIException{
      super(S_TYPE);
  }
