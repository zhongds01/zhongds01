...
public class SAComptelX extends DataContainer implements DataContainerInterface,ISAComptelX{
  private static final long serialVersionUID = -6687456204341064280L;
  private static String  m_boName = "com.ai.sacenter.base.competence.bo.SAComptelX";
  ...
  public SAComptelX() throws AIException{
      super(S_TYPE);
  }
