...
public class ISARocketHis extends DataContainer implements DataContainerInterface,IISARocket{
  private static final long serialVersionUID = -5615070639046680984L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISARocketHis";
  ...
  public ISARocketHis() throws AIException{
      super(S_TYPE);
  }
