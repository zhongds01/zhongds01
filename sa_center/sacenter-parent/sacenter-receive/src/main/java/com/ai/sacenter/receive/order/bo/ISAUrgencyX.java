...
public class ISAUrgencyX extends DataContainer implements DataContainerInterface,IISAUrgencyX{
  private static final long serialVersionUID = -4798256652586032738L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISAUrgencyX";
  ...
  public ISAUrgencyX() throws AIException{
      super(S_TYPE);
  }
