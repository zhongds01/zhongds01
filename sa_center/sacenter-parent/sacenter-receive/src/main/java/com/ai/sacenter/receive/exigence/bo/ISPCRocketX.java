...
public class ISPCRocketX extends DataContainer implements DataContainerInterface,IISPCRocketX{
  private static final long serialVersionUID = 4229064073810318408L;
  private static String  m_boName = "com.ai.sacenter.receive.exigence.bo.ISPCRocketX";
  ...
  public ISPCRocketX() throws AIException{
      super(S_TYPE);
  }
