...
public class ISPCRocket extends DataContainer implements DataContainerInterface,IISPCRocket{
  private static final long serialVersionUID = -6438030680783023525L;
  private static String  m_boName = "com.ai.sacenter.receive.exigence.bo.ISPCRocket";
  ...
  public ISPCRocket() throws AIException{
      super(S_TYPE);
  }
