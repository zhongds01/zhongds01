...
public class ISARocketXHis extends DataContainer implements DataContainerInterface,IISARocketX{
  private static final long serialVersionUID = 3048435663888523548L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISARocketXHis";
  ...
  public ISARocketXHis() throws AIException{
      super(S_TYPE);
  }
