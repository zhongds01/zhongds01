...
public class ISARocketX extends DataContainer implements DataContainerInterface,IISARocketX{
  private static final long serialVersionUID = 5917883593471045664L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISARocketX";
  ...
  public ISARocketX() throws AIException{
      super(S_TYPE);
  }
