...
public class SAExpire extends DataContainer implements DataContainerInterface,ISAExpire{
  private static final long serialVersionUID = -2686440838890885128L;
  private static String  m_boName = "com.ai.sacenter.receive.expire.bo.SAExpire";
  ...
  public SAExpire() throws AIException{
      super(S_TYPE);
  }
