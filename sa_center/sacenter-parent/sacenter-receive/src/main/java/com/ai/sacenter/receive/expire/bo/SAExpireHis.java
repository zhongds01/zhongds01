...
public class SAExpireHis extends DataContainer implements DataContainerInterface,ISAExpire{
  private static final long serialVersionUID = -4203874860302526596L;
  private static String  m_boName = "com.ai.sacenter.receive.expire.bo.SAExpireHis";
  ...
  public SAExpireHis() throws AIException{
      super(S_TYPE);
  }
