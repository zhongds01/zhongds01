...
public class ISAUrgencyXHis extends DataContainer implements DataContainerInterface,IISAUrgencyX{
  private static final long serialVersionUID = -2115677154059599517L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISAUrgencyXHis";
  ...
  public ISAUrgencyXHis() throws AIException{
      super(S_TYPE);
  }
