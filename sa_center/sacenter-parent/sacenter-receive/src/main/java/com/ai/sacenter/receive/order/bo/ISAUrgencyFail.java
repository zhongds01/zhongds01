...
public class ISAUrgencyFail extends DataContainer implements DataContainerInterface,IISAUrgency{
  private static final long serialVersionUID = 8590054567962519214L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISAUrgencyFail";
  ...
  public ISAUrgencyFail() throws AIException{
      super(S_TYPE);
  }
