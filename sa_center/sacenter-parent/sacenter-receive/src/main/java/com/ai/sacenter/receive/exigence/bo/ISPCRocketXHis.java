...
public class ISPCRocketXHis extends DataContainer implements DataContainerInterface,IISPCRocketX{
  private static final long serialVersionUID = -3887835534139898428L;
  private static String  m_boName = "com.ai.sacenter.receive.exigence.bo.ISPCRocketXHis";
  ...
  public ISPCRocketXHis() throws AIException{
      super(S_TYPE);
  }
