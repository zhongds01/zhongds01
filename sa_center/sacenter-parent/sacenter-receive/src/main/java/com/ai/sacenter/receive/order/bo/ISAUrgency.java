...
public class ISAUrgency extends DataContainer implements DataContainerInterface,IISAUrgency{
  private static final long serialVersionUID = -4829528730533943955L;
  private static String  m_boName = "com.ai.sacenter.receive.order.bo.ISAUrgency";
  ...
  public ISAUrgency() throws AIException{
      super(S_TYPE);
  }
