...
public class ISPCRocketXFail extends DataContainer implements DataContainerInterface,IISPCRocketX{
  private static final long serialVersionUID = 9072721777206789958L;
  private static String  m_boName = "com.ai.sacenter.receive.exigence.bo.ISPCRocketXFail";
  ...
  public ISPCRocketXFail() throws AIException{
      super(S_TYPE);
  }
