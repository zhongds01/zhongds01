...
package com.asiainfo.sacenter.shcmcc.receive.cboss.bean.iot.open.rsp;
 ...
 */
public class ECProductOrdeNoticeRequest implements java.io.Serializable {
    ...
    public ECProductOrdeNoticeRequest() 
     {
        super();
        _rsltList = new Vector();
    } //-- ECProductOrdeNoticeRequest()
