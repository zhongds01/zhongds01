...
public class BOISAEQUIPMENTNEWBean extends DataContainer implements DataContainerInterface,IBOISAEQUIPMENTNEWValue {

  private static String  m_boName = "com.asiainfo.sacenter.audit.bo.BOISAEQUIPMENTNEW";
  ...
  public BOISAEQUIPMENTNEWBean() throws AIException{
      super(S_TYPE);
  }
