 ...
 */
public class ECMemberOrderInfoNoticeRequest implements java.io.Serializable {
    ...
    public ECMemberOrderInfoNoticeRequest() 
     {
        super();
        _rsltList = new Vector();
    } //-- ECMemberOrderInfoNoticeRequest()
     ...
     * 
     * @param reader
     * @return ECMemberOrderInfoNoticeRequest
     */
