...
public class ISADsmpStatusHis extends DataContainer implements DataContainerInterface,IISAProvision{
  private static final long serialVersionUID = -2075011218714254291L;
  private static String  m_boName = "com.asiainfo.sacenter.shcmcc.provision.dsmp.bo.ISADsmpStatusHis";
  ...
  public ISADsmpStatusHis() throws AIException{
      super(S_TYPE);
  }
