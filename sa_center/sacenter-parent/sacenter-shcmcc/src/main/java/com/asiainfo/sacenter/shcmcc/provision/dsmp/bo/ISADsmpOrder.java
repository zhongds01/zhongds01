...
public class ISADsmpOrder extends DataContainer implements DataContainerInterface,IISADsmpOrder{
  private static final long serialVersionUID = -4719039617934365039L;
  private static String  m_boName = "com.asiainfo.sacenter.shcmcc.provision.dsmp.bo.ISADsmpOrder";
  ...
  public ISADsmpOrder() throws AIException{
      super(S_TYPE);
  }
