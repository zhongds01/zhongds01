...
public class ISADsmpStatus extends DataContainer implements DataContainerInterface,IISADsmpStatus{
  private static final long serialVersionUID = -2492945225251687879L;
  private static String  m_boName = "com.asiainfo.sacenter.shcmcc.provision.dsmp.bo.ISADsmpStatus";
  ...
  public ISADsmpStatus() throws AIException{
      super(S_TYPE);
  }
