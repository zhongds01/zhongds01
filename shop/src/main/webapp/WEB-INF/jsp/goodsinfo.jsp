    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-striped">
                ...
                <tbody  v-for="(good,index) in goods":key="good.goodsId">
                <tr>
                    <td>
                        {{good.goodsId}}
                    </td>
                    ...
                    <td>
                        <img style="width: 40px;height: 30px" :src="'/images/'+good.goodsPic" alt="Goods image">
                    </td>
                    <td>
                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModal">修改</button>
                        <button class="btn btn-sm btn-danger" @click="deleteGoods(good.goodsId)"><span class="glyphicon glyphicon-trash"></span></button>
                        <%--modal--%>
